#
#  Be sure to run `pod spec lint CYXCyclingPlayerView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "xq-120"
  # s.authors            = { "xq-120" => "1204556447@qq.com" }
  # s.social_media_url   = "http://twitter.com/xq_120"
  ...
  s.dependency "JKPresentationController", "~> 1.0.0"
